window.addEventListener("DOMContentLoaded", () => {
  ...
  function mostrarDatos(data) {
    ...
    p1.textContent="el pueblo con la temperatura mas alta es ->"+puebloTemperaturaAlta+" con "+tmp1+" grados"
    const p2 = document.createElement('p')
    contenedor.appendChild(p2);
    p2.textContent="el pueblo con la lluvia mas alta es ->"+puebloMasLluvia+" con "+tmp2+" L/m2"
...
function calcularTempMaxPluviometria(){
  ...
  p.textContent="La media de pluviometria es -->"+pluviometriaMedia.toFixed(2)
